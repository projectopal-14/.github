...
AI modes:
  ...
  3. Managed cloud:
     пользователь входит в аккаунт, AI-запросы могут реализовываться через удаленный сервер продукта с лимитами, подпиской и централизованным управлением моделями.
